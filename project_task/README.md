...
Проектирумые ЦОДы будут находиться в Москве (AS 65001) и Амстердаме (AS 65002). Соединять их планируем через ряд провайдеров, которые в нашей схеме обозанчены L3-коммутатором DCI с AS 65000.
